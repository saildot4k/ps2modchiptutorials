...
[![Tindie](assets/picfix/tindie-mediums.png){ width="100" align=left }](https://www.tindie.com/products/r3z3n/sony-ps2-matrix-picfix-flex-for-scph-700xx/) Tindie is a better choice for bulk purchases over 10 as it is $1 savings per unit. $8/per or $7/per 10 units and over. Shipping is $5 in USA as it includes tracking.

[![Ko-Fi](assets/picfix/support_me_on_kofi_badge_red.png){ width="100" align=left}](https://ko-fi.com/r3z3n/shop) $8/per and shipping is $5 in USAas it includes tracking. Gerbers, BOM and Placement file here as well!
